-- SQL script to add 20 rooms with images to the hotel_booking database
-- Run this script in MySQL to add rooms directly

USE hotel_booking;

-- Insert 20 diverse rooms with high-quality Unsplash images
-- Note: Column names use snake_case as per JPA naming convention
