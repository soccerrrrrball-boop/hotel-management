-- SQL script to add rooms to Railway MySQL database
-- Database: railway
...
-- Insert 20 rooms with all required fields
-- Note: Railway table structure requires: price, room_number, capacity, is_available, status
