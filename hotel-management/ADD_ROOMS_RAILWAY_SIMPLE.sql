-- SIMPLE SQL script for Railway (if table structure matches Spring Boot entity)
-- Database: railway
-- Connect to: tramway.proxy.rlwy.net:24748

USE railway;

-- Insert 20 rooms (assuming table matches Room entity: id, roomType, roomPrice, roomPhotoUrl, roomDescription)
