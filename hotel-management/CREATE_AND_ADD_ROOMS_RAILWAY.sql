-- Create rooms table and add rooms to Railway MySQL database
-- Database: railway
-- This script creates the table structure matching Spring Boot Room entity

USE railway;

-- Create the rooms table if it doesn't exist
-- This matches the Spring Boot Room entity structure
